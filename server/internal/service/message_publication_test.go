...
func outputFixture(t *testing.T) (*repo.Store, *MessageService, *MessageService) {
	...
	if _, err := store.CreateChatInput(ctx, model.Message{ID: "00000000-0000-7000-8000-000000000001", ConversationID: "root", TaskID: "task", SourceKind: "user", SourceKey: "human", Content: initial}); err != nil {
		t.Fatal(err)
	}
