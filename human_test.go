...
func TestHumanRequestModes(t *testing.T) {
	base := HumanRequest{ConversationID: "conv", Actor: ActorRef{Kind: ActorKindOperator, Key: "router"}, Target: ActorRef{Kind: ActorKindUser, Key: "alice"}, EffectKey: "effect", Type: "ask", Title: "Scope", Prompt: "Choose", Timeout: time.Minute, Choices: []HumanChoice{{Value: "small", Label: "Small"}}}
