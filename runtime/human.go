...
func (h Human) Ask(ctx context.Context, r AskRequest) (*HumanHandle, error) {
	return h.create(ctx, contract.HumanRequest{ConversationID: r.ConversationID, Actor: r.Actor, Target: r.Target, ReplyToID: r.ReplyToID, EffectKey: r.EffectKey, Type: "ask", Title: r.Title, Prompt: r.Prompt, Timeout: r.Timeout, Choices: r.Choices, AllowOther: r.AllowOther})
}
...
func (h Human) Confirm(ctx context.Context, r ConfirmRequest) (*HumanHandle, error) {
	return h.create(ctx, contract.HumanRequest{ConversationID: r.ConversationID, Actor: r.Actor, Target: r.Target, ReplyToID: r.ReplyToID, EffectKey: r.EffectKey, Type: "confirm", Title: r.Title, Prompt: r.Prompt, Timeout: r.Timeout, ConfirmLabel: r.ConfirmLabel, DeclineLabel: r.DeclineLabel})
}
